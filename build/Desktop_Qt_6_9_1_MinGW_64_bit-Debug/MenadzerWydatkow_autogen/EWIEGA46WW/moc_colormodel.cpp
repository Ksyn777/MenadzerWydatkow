...
template <> constexpr inline auto ColorModel::qt_create_metaobjectdata<qt_meta_tag_ZN10ColorModelE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ColorModel, qt_meta_tag_ZN10ColorModelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject ColorModel::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ColorModelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ColorModelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10ColorModelE_t>.metaTypes,
    nullptr
} };
...
void *ColorModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ColorModelE_t>.strings))
